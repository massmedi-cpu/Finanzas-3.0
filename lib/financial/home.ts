...
import type { ReconciliationOverview } from "@/lib/financial/reconciliation";
export type HomeOverview={version:string;dashboard:FinancialDashboard;accounts:AccountsOverview;budget:BudgetMonth;forecast:ForecastOverview;analysis:AnalysisOverview;reconciliation:ReconciliationOverview;controlSummary:{visibleAlerts:number;hiddenAlerts:number;closeReady:boolean;closeBlockers:number;closeWarnings:number}};
