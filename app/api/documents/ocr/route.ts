...
import { ReceiptRowRefiningImageOcrProvider } from "../../../../src/infrastructure/ocr/receipt-row-refining-provider";
import {
...
const imageProvider = new ReceiptRowRefiningImageOcrProvider();
