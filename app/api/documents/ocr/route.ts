...
import { ReceiptColumnSweepImageOcrProvider } from "../../../../src/infrastructure/ocr/receipt-column-sweep-provider";
import {
...
const imageProvider = new ReceiptColumnSweepImageOcrProvider();
