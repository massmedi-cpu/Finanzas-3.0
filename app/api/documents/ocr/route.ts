...
import { ReceiptCellRecoveryImageOcrProvider } from "../../../../src/infrastructure/ocr/receipt-cell-recovery-provider";
import {
...
const imageProvider = new ReceiptCellRecoveryImageOcrProvider();
