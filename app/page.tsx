  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-foot"><span className="status-dot" /> Sesión protegida · fuente solo lectura</div>
      </aside>
      <section className="workspace">
        <header className="topbar"><div><p className="eyebrow">INICIO</p><h1>Tu situación financiera</h1><p>Vista rápida del presente, el histórico y lo que viene.</p></div><button className="ghost" disabled title="Se activará en la fase de sincronización">Actualizar datos</button></header>
        ...
        <div className="content-grid">
          ...
          <article className="panel"><div className="panel-head"><div><p className="eyebrow">CONTROL</p><h2>Estado del sistema</h2></div></div><ul className="health-list"><li><b>Autenticación</b><span>Google OAuth · server-side</span></li><li><b>Fuente</b><span>Google Sheets · solo lectura</span></li><li><b>Cash Flow ahorro</b><span>Excluido por regla central</span></li><li><b>Versión</b><span>0.1.0 · Foundation</span></li></ul></article>
        </div>
      </section>
    </main>
  );
