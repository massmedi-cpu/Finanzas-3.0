...
export default async function Home(){
  ...
  return <main className="app-shell"><AppSidebar active="/" status={`Inicio · ${dashboard.version}`}/><section id="main-content" tabIndex={-1} className="workspace home-workspace">
    ...
    <div className="home-main-grid">
      <article className="panel home-chart-panel"><div className="panel-head"><div><p className="eyebrow">EVOLUCIÓN {year}</p><h2>Ingresos, gastos y Cash Flow</h2></div><Link className="pill pill-link" href="/cash-flow">Abrir Cash Flow</Link></div>{analysis&&cashFlowPoints.length?<CashFlowChart points={cashFlowPoints} drilldown={{bucket:"month",dateFrom:analysis.periodStart,dateTo:analysis.periodEnd,account:"",type:"",category:"",subcategory:"",merchant:""}}/>:<div className="home-empty">No se pudo cargar la evolución financiera.</div>}</article>
