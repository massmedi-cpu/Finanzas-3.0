  ...
  return <main className="app-shell">
    ...
    <section className="workspace">
      ...
      <div className="content-grid">
        <article className="panel"><div className="panel-head"><div><p className="eyebrow">PLANIFICACIÓN</p><h2>Presupuesto y previsión</h2></div><Link className="pill pill-link" href="/prevision">Abrir Previsión</Link></div><div className="chart-placeholder"><div className="chart-line" /><span>Control mensual y proyección del saldo futuro conectados al mismo histórico real, con recurrencias explicables y confirmables.</span></div></article>
        <article className="panel"><div className="panel-head"><div><p className="eyebrow">CONTROL</p><h2>Estado del sistema</h2></div></div><ul className="health-list"><li><b>Autenticación</b><span>Google OAuth · server-side</span></li><li><b>Fuente</b><span>Google Drive XLSX · solo lectura</span></li><li><b>Última sincronización</b><span>{dashboard.sync?.status==="success"?"Correcta":"Pendiente"}</span></li><li><b>Último movimiento</b><span>{dashboard.lastMovementDate?date.format(new Date(dashboard.lastMovementDate+"T12:00:00")):"—"}</span></li><li><b>Versión</b><span>{dashboard.version} · Previsión real</span></li></ul></article>
      </div>
    </section>
  </main>;
}
