  ...
  return <main className="app-shell">
    ...
    <section className="workspace">
      ...
      <div className="content-grid">
        <article className="panel"><div className="panel-head"><div><p className="eyebrow">CONTROL</p><h2>Presupuesto y Cash Flow</h2></div><Link className="pill pill-link" href="/presupuesto">Abrir Presupuesto</Link></div><div className="chart-placeholder"><div className="chart-line" /><span>Control mensual por categorías y evolución anual del dinero conectados a los mismos movimientos reales.</span></div></article>
        <article className="panel"><div className="panel-head"><div><p className="eyebrow">CONTROL</p><h2>Estado del sistema</h2></div></div><ul className="health-list"><li><b>Autenticación</b><span>Google OAuth · server-side</span></li><li><b>Fuente</b><span>Google Drive XLSX · solo lectura</span></li><li><b>Última sincronización</b><span>{dashboard.sync?.status==="success"?"Correcta":"Pendiente"}</span></li><li><b>Último movimiento</b><span>{dashboard.lastMovementDate?date.format(new Date(dashboard.lastMovementDate+"T12:00:00")):"—"}</span></li><li><b>Versión</b><span>{dashboard.version} · Presupuesto real</span></li></ul></article>
      </div>
    </section>
  </main>;
}
