...
export const metadata = {
  ...
  description: "Estado verificable de protección, ciclo de datos y operación técnica de Financial App.",
};
...
const SECTION_LABELS: Record<DataTrustSection, { title: string; description: string }> = {
  ...
  commercial_readiness: {
    ...
    description: "Controles internos de diagnóstico y estado técnico del servicio.",
  },
};
