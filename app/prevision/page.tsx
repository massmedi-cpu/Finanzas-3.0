...
export default async function PrevisionPage() {
  ...
  if (isGoogleSheetsConfigured()) {
    try {
      ...
      if (baseDate) {
        forecast = combineForecasts(buildForecast(patterns, baseDate, 365), expandPlannedEvents(futureEvents, baseDate, 365));
