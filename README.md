...
- Desde 6.4.9 `home.css` se carga únicamente en Inicio y `archive-review.css` únicamente bajo Archivo; `document-linking.css` permanece compartido porque sirve tanto a Archivo como a Movimientos. Se eliminan 11.251 bytes de CSS específico del ámbito raíz sin alterar el diseño validado.
