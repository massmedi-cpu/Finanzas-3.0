...
- `forecast_scenario_core` reutiliza `forecast_liquidity_core`; superpone únicamente impactos hipotéticos y no introduce un segundo forecast ni recalcula saldos en React.
...
- Los gates históricos siguen activos. Desde 6.5.0 las baselines 6.4.0–6.4.11 usan un comparador semántico común; 7.0.0 añade gates específicos de liquidez futura y 8.0.0 añade gates específicos del simulador efímero.
- `docs/ARCHITECTURE.md` y `docs/CANONICAL_ARCHITECTURE.md` describen una única arquitectura canónica iniciada en 5.0.0; 8.0.0 amplía esa arquitectura sin crear runtime paralelo.
