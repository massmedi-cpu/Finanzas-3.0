...
-- Financial App 9.0.0 — matching documental por rutas indexables.
-- Conserva exactamente la política, scoring, ranking y explicabilidad del motor
-- 6.1/6.2, pero separa standard/installment para que PostgreSQL pueda usar
-- transactions_document_match_idx antes de normalizar texto y puntuar candidatos.
...
-- El motor sigue siendo privado. No se cambia ningún wrapper ni permiso público.
