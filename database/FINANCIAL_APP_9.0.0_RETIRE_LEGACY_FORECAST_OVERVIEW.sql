...
-- financial_app.forecast_overview_core(date,integer), porque Plan y Escenarios
...
drop function if exists public.financial_app_forecast_overview(date,integer) restrict;
