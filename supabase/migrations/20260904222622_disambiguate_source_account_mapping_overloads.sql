drop function financial_app.ensure_source_account_mapping(text,text,text,text,text,bigint,text,text);

create function financial_app.ensure_source_account_mapping(
