...
const rowRenderPaths=[...view.matchAll(/<MovementRow\b/g)];
assert.equal(rowRenderPaths.length,1,"Movimientos debe tener una sola ruta visual por item, no duplicar tabla y tarjetas por breakpoint");
...
console.log("Movement single-render tests OK · una sola fila visual por movimiento en desktop/móvil, DOM duplicado eliminado");
