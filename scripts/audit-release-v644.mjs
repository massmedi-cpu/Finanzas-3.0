...
must(currentVersion==="6.4.4","APP_VERSION debe ser exactamente 6.4.4");
...
console.log("Financial App 6.4.4 release audit OK · automatización v4 retirada y transición 6.4.3→6.4.4 protegida");
