...
must(versionAtLeast(currentVersion,"6.4.4"),"APP_VERSION debe preservar como mínimo la baseline 6.4.4");
...
console.log(`Financial App 6.4.4 release audit OK · baseline preservada por ${currentVersion}`);
