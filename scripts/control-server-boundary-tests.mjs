...
assert.ok(actions.includes("ControlMutationBoundary")&&actions.includes("ControlMutationFeedback"),"el estado interactivo global debe quedar aislado en una frontera cliente mínima");
assert.ok(view.includes("ControlMutationBoundary")&&view.includes("ControlMutationFeedback"),"la vista servidor debe conservar feedback y bloqueo global sin hidratar el snapshot");
...
console.log("control server boundary tests OK · snapshot en servidor, feedback persistente y mutaciones aisladas en cliente");
