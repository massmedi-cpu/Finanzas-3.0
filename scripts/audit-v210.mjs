...
const errors=[];
const need=["components/intent-link.tsx","components/app-navigation.tsx","app/loading.tsx","app/globals.css","app/chrome.css","docs/RELEASE_GATE_V2.1.0.md","docs/PERFORMANCE_V2.1.0.md","docs/COHERENCE_V2.1.0.md","docs/legacy/RELEASE_GATE_V2.1.0_PRE_REBUILD.md"];
