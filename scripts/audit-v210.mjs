...
if(!errors.length){
  ...
  if(touchWarm&&!intent.includes('onTouchStart={event=>{warm();'))errors.push("IntentLink 4.5+ debe precalentar el destino en touchstart");
  if(!touchWarm&&intent.includes('onTouchStart={event=>{warm();'))errors.push("IntentLink pre-4.5 no debe duplicar prefetch táctil");
  ...
  if(!homePage.includes("getForecastOverview(30)"))errors.push("Inicio no solicita el horizonte inmediato canónico de 30 días");
  if(!homeSections.includes("PRÓXIMOS 30 DÍAS"))errors.push("Inicio no identifica visualmente el horizonte inmediato de 30 días");
