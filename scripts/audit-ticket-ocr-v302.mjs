...
must(appVersion.includes('APP_VERSION = "3.1.2"'),"La versión visible de esta entrega debe ser 3.1.2");
...
console.log("audit-ticket-ocr-v302 OK · OCR geométrico · total seguro · auto-upgrade · versión 3.1.2");
