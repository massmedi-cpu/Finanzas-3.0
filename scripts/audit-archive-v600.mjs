...
for(const token of ['getArchiveOverview','archiveOverview(search,false)','getArchivedDocuments','Boolean(document.archivedAt)'])if(!data.includes(token))failures.push(`Consulta documental sin separación activo/histórico: ${token}`);
...
console.log("Archive v6 audit OK · Nuevas/Pendientes/Archivadas separados, histórico reversible y migración idempotente protegidos");
