...
for(const token of ["ArchiveClientCore","ArchiveBulkOcrRecovery"])if(!wrapper.includes(token))failures.push(`Wrapper activo de Archivo incompleto: ${token}`);
...
console.log("Archive v6 audit OK · Nuevas/Pendientes/Archivadas separados, archivado activo + histórico reversible y wrapper/core OCR protegidos");
