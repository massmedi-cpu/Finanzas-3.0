...
const headers={accept:"application/json","user-agent":"Financial-App-authenticated-preview-e2e/4.5"};
...
if(payload.ok!==true||payload.privateSession!==true||payload.version!=="4.5.0")throw new Error("Probe identity/version contract failed");
const expectedChecks=["archiveReadable","dashboardReadable","forecastContracts","forecastReadable","homePulseReadable","intelligenceContracts","intelligenceReadable","matchingObservabilityReadable","matchingQualityGate","movementsReadable"];
...
console.log("Authenticated preview E2E OK · private home pulse, dashboard, movements, forecast, archive, matching-quality and actionable intelligence verified · token replay rejected");
