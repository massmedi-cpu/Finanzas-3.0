...
const requiredFiles = [
  ...
  'docs/V2.6.0_CLASSIFICATION_RULES.md',
  'docs/V2.7.0_EXPLAINABILITY.md',
  ...
  'database/V2.6.0_RULES_MIGRATIONS.md',
  'database/V2.7.0_EXPLAINABILITY_MIGRATIONS.md',
  'src/domain/long-horizon-engine.ts',
  'src/domain/forecast-calendar-engine.ts',
  'src/domain/month-close-engine.ts',
  'src/domain/classification-rule-engine.ts',
  'src/domain/classification-origin.ts',
  'src/private-data/month-closure.ts',
  'src/private-data/rules.ts',
  'src/private-data/explainability.ts',
  'scripts/long-horizon-tests.mjs',
  'scripts/month-close-tests.mjs',
  'scripts/classification-rule-tests.mjs',
  'scripts/explainability-tests.mjs',
  'app/forecast-calendar.css',
  'app/close.css',
  'app/rules.css',
  'app/explainability.css',
  'app/cierre/page.tsx',
  'app/reglas/page.tsx',
  'app/reglas/RulesManager.tsx',
  'app/explicabilidad/page.tsx',
  'app/explicabilidad/SuggestionManager.tsx',
  'app/api/private/rule/route.ts',
  'app/api/private/rule-preview/route.ts',
  ...
  'supabase/functions/finanzas-v3-rules/index.ts',
  'supabase/functions/finanzas-v3-explainability/index.ts',
];
...
for (const script of ['scripts/long-horizon-tests.mjs','scripts/month-close-tests.mjs','scripts/classification-rule-tests.mjs','scripts/explainability-tests.mjs']) {
  assert.equal(ci.includes(script), true, `CI debe ejecutar ${script}`);
}

const deploymentEnabled = vercel.git?.deploymentEnabled || {};
for (const branch of ['develop/v2.2.0-analytics', 'develop/v2.3.0-intelligence', 'develop/v2.4.0-long-horizon', 'develop/v2.5.0-month-close', 'develop/v2.6.0-rules', 'develop/v2.7.0-explainability']) {
