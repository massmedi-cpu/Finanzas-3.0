...
const backupManager = readFileSync('app/copias/BackupManager.tsx', 'utf8');
assert.equal(backupManager.includes('RESTAURAR'), true, 'V2.9 debe exigir confirmación explícita antes de restaurar');
