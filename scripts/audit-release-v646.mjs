...
must(versionAtLeast(currentVersion,"6.4.6"),"APP_VERSION debe preservar como mínimo la baseline 6.4.6");
...
console.log(`Financial App 6.4.6 release audit OK · baseline preservada por ${currentVersion} · reconciliación Drive protegida`);
