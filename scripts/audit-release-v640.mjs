...
must(["6.4.0","6.4.1"].includes(currentVersion),"APP_VERSION debe preservar la baseline 6.4.0 o su hardening 6.4.1");
...
console.log("Financial App 6.4.0 release audit OK · baseline preservada por 6.4.1, operaciones supervisadas, lote revalidado y reversibilidad protegidas");
