...
must(currentVersion==="6.4.0","APP_VERSION debe ser exactamente 6.4.0");
...
console.log("Financial App 6.4.0 release audit OK · operaciones supervisadas, lote revalidado, reversibilidad y transición 6.3.2→6.4.0 protegidas");
