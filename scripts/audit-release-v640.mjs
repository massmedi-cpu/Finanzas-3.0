...
must(versionAtLeast(currentVersion,"6.4.0"),"APP_VERSION debe preservar como mínimo la baseline 6.4.0");
...
console.log(`Financial App 6.4.0 release audit OK · baseline preservada por ${currentVersion}, operaciones supervisadas y reversibilidad protegidas`);
