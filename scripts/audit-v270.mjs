...
const required=[
  ...
  "lib/financial/explainability-shared.ts",
...
console.log("Financial App 2.7 audit OK · explicabilidad solo lectura, frontera server/client, preview obligatorio y protección de regresiones");
