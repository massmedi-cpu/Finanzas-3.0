...
must(currentVersion==="6.4.7","APP_VERSION debe ser exactamente 6.4.7");
...
console.log("Financial App 6.4.7 release audit OK · edición múltiple reversible y transición 6.4.6→6.4.7 protegidas");
