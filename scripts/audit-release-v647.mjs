...
must(versionAtLeast(currentVersion,"6.4.7"),"APP_VERSION debe preservar como mínimo la baseline 6.4.7");
...
console.log(`Financial App 6.4.7 release audit OK · baseline preservada por ${currentVersion} · edición múltiple reversible protegida`);
