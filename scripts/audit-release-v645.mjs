...
must(versionAtLeast(currentVersion,"6.4.5"),"APP_VERSION debe preservar como mínimo la baseline 6.4.5");
...
console.log(`Financial App 6.4.5 release audit OK · baseline preservada por ${currentVersion} · compatibilidad Drive real protegida`);
