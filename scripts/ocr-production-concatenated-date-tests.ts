...
assert.equal(RECEIPT_PARSER_REVISION,"parser_v8");
...
console.log("OCR production concatenated date tests OK · parser_v8 conserva FECHA29/08/2026, JUAN y el bloqueo del 1460 ambiguo");
