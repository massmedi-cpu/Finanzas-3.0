...
const authBoundary=read("database/FINANCIAL_APP_9.0.0_ARCHIVE_LIFECYCLE_AUTH.sql");
...
])if(!authBoundary.toLowerCase().includes(token))failures.push(`Frontera pública de Archivo incompleta: ${token}`);
