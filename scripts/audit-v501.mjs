...
must(revision.includes('image_ocr_receipt_v501:server_tesseract_7_geometry_v1:parser_v7:')&&revision.includes('image_ocr_receipt_v501:paddle_layout_v6:parser_v7:'),"La transición parser-only debe reconocer evidencia visual v7 compatible sin presentar Paddle histórico como Tesseract actual");
