...
must(versionAtLeast(currentVersion,"6.4.1"),"APP_VERSION debe preservar como mínimo la baseline 6.4.1");
...
console.log(`Financial App 6.4.1 release audit OK · baseline preservada por ${currentVersion}, índice medido y contratos canónicos protegidos`);
