...
console.log("OCR bulk recovery trust UX tests OK · metadatos pendientes marcados provisionales y resultado individual visible sin alterar seguridad secuencial");
