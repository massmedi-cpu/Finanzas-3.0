...
must(currentVersion==="6.4.2","APP_VERSION debe ser exactamente 6.4.2");
...
console.log("Financial App 6.4.2 release audit OK · frontera RPC hardened y transición 6.4.1→6.4.2 protegida");
