...
must(versionAtLeast(currentVersion,"6.4.2"),"APP_VERSION debe preservar como mínimo la baseline 6.4.2");
...
console.log(`Financial App 6.4.2 release audit OK · baseline preservada por ${currentVersion} y frontera RPC hardened protegida`);
