...
must(version.includes('APP_VERSION = "6.3.0"'),"APP_VERSION debe ser 6.3.0");
...
console.log("Financial App 6.3.0 release audit OK · triage universal, política canónica, acciones explícitas y cierre metadata-only protegidos");
