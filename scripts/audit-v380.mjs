...
for(const token of ["MAX_BULK_MOVEMENTS = 200","financial_app_bulk_update_transactions","no_transactions_selected","bulk_limit_exceeded"])
...
console.log("Financial App 3.8.0 audit OK · edición múltiple atómica, Drive read-only, auto-sync y límites de seguridad protegidos");
